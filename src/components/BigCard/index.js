...
import {date_default,weekDayToday,convertToDateObject,convertDate_ptBR,time} from '../../services/DateTime';
...
export default ()=>{
    ...
    const updateTask=async ()=>{
        let response=await Api.updateTask(id,title,start,end,importance,description,imageIcon,idUser);
    ...
    return (
        <Style.BigCard>
            <Style.Scroller>
                <Style.ActionButtonClose onPress={()=> navigation.reset({
                    index:1,
                ...
                <Style.Header>
                    <Style.CardIconTouchable onPress={()=>edit?openFileViewer():null}>
                        <Style.CardIcon 
                ...
                <Style.CardTitle>
                    ...
                    {edit &&
                        <Style.CardInfoSlot>
                            <Style.CardInfoInput autoFocus={true} 
                                value={title} 
                    ...
                    <Style.CardInfoSlot>
                        {!edit && 
                            <>
                                ...
                                <Style.CardInfoDescription>{description}</Style.CardInfoDescription>
                            </>
                        }
                ...
                <Style.Footer>
                    <Style.ActionButton onPress={()=>navigation.navigate('RepeatWeek',
                        {
                            id:cardInfo.id,
                            infoRepeat:cardInfo.infoRepeat
                        })}>
                        <Style.ActionButtonIcon source={require("../../assets/Images/repeat.png")} resizeMode='contain'/>
                    </Style.ActionButton>
                    
                    <Style.ActionButton onPress={()=>{setSelected(!selected)}}>
                        {selected &&
                            <Style.ActionButtonIcon source={require("../../assets/Images/check.png")} resizeMode='contain'/>
                        }

                        {!selected &&
                            <Style.ActionButtonIcon source={require("../../assets/Images/checkEmpty.jpg")} resizeMode='contain'/>
                        }
                    </Style.ActionButton>

                    {edit &&
                        <Style.ActionButton onPress={()=>{updateTask()}}>
                            <Style.ActionButtonIcon source={require("../../assets/Images/save.png")} resizeMode='contain'/>
                        </Style.ActionButton>
                    }
                    <Style.ActionButton onPress={editMode}>
                        <Style.ActionButtonIcon source={require("../../assets/Images/edit.png")} resizeMode='contain'/>
                    </Style.ActionButton>

                    <Style.ActionButton onPress={()=>{setShowAlertError(true)}}>
                        <Style.ActionButtonIcon source={require("../../assets/Images/trash.png")} resizeMode='contain'/>
                    </Style.ActionButton>
                </Style.Footer>
            </Style.Scroller>

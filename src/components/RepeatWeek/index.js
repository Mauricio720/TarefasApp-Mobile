    ...
    return (
        <Style.RepeatWeek>
            ...
            <Style.ContainerItems>
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(7,repeatWeek.everyDay)}}>
                        {repeatWeek.everyDay &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }

                        {repeatWeek.everyDay===false &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/checkEmpty.jpg")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(1,repeatWeek.mon)}}>
                        {repeatWeek.mon &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(2,repeatWeek.tue)}}>
                        {repeatWeek.tue &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(3,repeatWeek.wed)}}>
                        {repeatWeek.wed &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(4,repeatWeek.thu)}}>
                        {repeatWeek.thu &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(5,repeatWeek.fri)}}>
                        {repeatWeek.fri &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(6,repeatWeek.sat)}}>
                        {repeatWeek.sat &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
                ...
                <Style.RepeatItem>
                    <Style.RepeatItemCheckTouch onPress={()=>{setWeekSelected(0,repeatWeek.sun)}}>
                        {repeatWeek.sun &&
                            <Style.RepeatItemCheckImage source={require("../../assets/Images/check.png")}/>
                        }
        ...
        <Style.Footer>
            <Style.ButtonSave onPress={()=>{sendRepeatDays()}}>

...
export default (props)=>{
    ...
    return (
        <Style.Card>
            <Style.Header>
                <Style.CardIcon 
                    source={props.data.task_path?{uri:`${props.data.task_path}`}:require("../../assets/Images/typeTask.png")} 
                    resizeMode='cover'
                />
                <Style.HeaderButtonsContainer>
                    <Style.HeaderButton 
                        ...
                        {selected?
                            <Style.ButtonIcon source={require("../../assets/Images/check.png")}/>
                            :
                            <Style.ButtonIcon source={require("../../assets/Images/checkEmpty.jpg")}/>
                        }
                    ...
                    <Style.HeaderButton 
                        ...
                        <Style.ButtonIcon source={require("../../assets/Images/trash.png")}/>
                    </Style.HeaderButton>
            ...
            <Style.CardInfoArea>
                ...
                <Style.CardInfoSlot>
                    <Style.CardInfo>{importanceTitle[props.data.importance]}</Style.CardInfo>
                </Style.CardInfoSlot>
            </Style.CardInfoArea>

            <Style.CardSeeMoreBtn onPress={changeScreen}>
                <Style.SeeMoreBtnText>clique para ver mais</Style.SeeMoreBtnText>

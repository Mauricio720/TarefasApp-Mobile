...
export default () => {
  ...
  const [imgProfile, setImageProfile] = useState({
    uri: context.user.user.profileImg,
  });
        ...
        <Style.Footer>
          {edit && (
            <>
              <Style.Button
                ...
                <Style.ButtonText>Salvar</Style.ButtonText>
              </Style.Button>
              ...
              <Style.Button
                ...
                <Style.ButtonText>Desabilitar Edição</Style.ButtonText>
              </Style.Button>
            </>
          )}
          ...
          {!edit && (
            <Style.Button
              ...
              <Style.ButtonText>Editar</Style.ButtonText>
            </Style.Button>
          )}
        </Style.Footer>
      </Style.Scroller>
